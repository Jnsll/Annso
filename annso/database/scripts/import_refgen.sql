...
INSERT INTO public.annotation_field(database_uid, ord, wt_default, name, name_ui, type, description, meta) VALUES
  ('0f562de4f9474fd90132273d9414cc0a', 1,  True,  'name',          'name',         'string', 'Gene name.', NULL),
  ...
  ('0f562de4f9474fd90132273d9414cc0a', 3,  False, 'strand',        'strand',       'string', 'Which DNA strand contains the observed alleles.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 4,  False, 'txstart',       'txstart',      'int',    'Transcription start position.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 5,  False, 'txend',         'txend',        'int',    'Transcription end position.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 6,  False, 'txrange',       'txrange',      'range',  'Transcription region [start-end].', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 7,  False, 'cdsstart',      'cdsstart',     'int',    'Coding region start.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 8,  False, 'cdsend',        'cdsend',       'int',    'Coding region end.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 9,  False, 'cdsrange',      'cdsrange',     'range',  'Coding region [start-end].', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 10, False, 'exoncount',     'exoncount',    'int',    'Number of exons in the gene.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 11, False, 'score',         'score',        'int',    'Score ?', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 12, False, 'name2',         'name2',        'string', 'Alternative name.', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 13, False, 'cdsstartstat',  'cdsstartstat', 'string', 'Cds start stat, can be "non", "unk", "incompl" or "cmp1".', NULL),
  ('0f562de4f9474fd90132273d9414cc0a', 14, False, 'cdsendstat',    'cdsendstat',   'string', 'Cds end stat, can be "non", "unk", "incompl" or "cmp1".', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 1,  False, 'name',          'name',         'string', 'Gene name.', NULL),
  ...
  ('8cb1ac768951cef7ae600256d97aed03', 3,  False, 'strand',        'strand',       'string', 'Which DNA strand contains the observed alleles.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 4,  False, 'txstart',       'txstart',      'int',    'Transcription start position.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 5,  False, 'txend',         'txend',        'int',    'Transcription end position.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 6,  False, 'txrange',       'txrange',      'range',  'Transcription region [start-end].', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 7,  False, 'cdsstart',      'cdsstart',     'int',    'Coding region start.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 8,  False, 'cdsend',        'cdsend',       'int',    'Coding region end.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 9,  False, 'cdsrange',      'cdsrange',     'range',  'Coding region [start-end].', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 10, False, 'exoncount',     'exoncount',    'int',    'Number of exons in the gene.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 11, False, 'exonstart',     'exonstart',    'int',    'Exon start position.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 12, False, 'exonend',       'exonend',      'int',    'Exon end position.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 13, False, 'exonrange',     'exonrange',    'range',  'Exon region [start-end].', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 14, False, 'score',         'score',        'int',    'Score ?', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 15, False, 'name2',         'name2',        'string', 'Alternative name.', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 16, False, 'cdsstartstat',  'cdsstartstat', 'string', 'Cds start stat, can be "non", "unk", "incompl" or "cmp1".', NULL),
  ('8cb1ac768951cef7ae600256d97aed03', 17, False, 'cdsendstat',    'cdsendstat',   'string', 'Cds end stat, can be "non", "unk", "incompl" or "cmp1".', NULL);
